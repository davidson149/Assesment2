...
//CODE HERE
const empOne = new employee ('Zach','Weekends') 
/*
...
//CODE HERE
const empTwo = new employee ('Nick','Weekends')
...
//CODE HERE
const manager = new employee ('Darrel','Weekdays','Zach','Nick')
